"""
Udacity SDC behavioral cloning project
Reference: https://github.com/dolaameng/Udacity-SDC_Behavior-Cloning.git
...
class SteerRegressionModel(object):
	...
	def _build_vgg16_pretrained(self):
		...
		x = Dense(1024, activation="elu", W_regularizer=l2(0.01))(x)
		x = Dense(1, activation="linear")(x)
